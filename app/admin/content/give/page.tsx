...
export default function AdminContentGivePage() {
  ...
  return (
    <div className="p-8 max-w-2xl space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-[#1B2A4A]">Edit Give / Support Page</h1>
      ...
      <form onSubmit={handleSave} className="bg-white rounded-2xl border border-slate-100 p-6 space-y-5">
        <div>
          <label className="block text-xs font-semibold text-[#1B2A4A] mb-1.5">Page Title</label>
          <input
            type="text"
        ...
        <div>
          <label className="block text-xs font-semibold text-[#1B2A4A] mb-1.5">Page Subtitle / Description</label>
          <textarea
            rows={3}
        ...
        <div>
          <label className="block text-xs font-semibold text-[#1B2A4A] mb-1.5">Bank / Wire Transfer Details</label>
          <textarea
            rows={5}
            ...
            className="w-full px-4 py-3 rounded-xl border border-slate-200 text-sm resize-y focus:outline-none focus:ring-2 focus:ring-[#F2B134] font-mono"
          />
          <p className="text-xs text-slate-400 mt-1">Shown in a formatted block on the Give page.</p>
        </div>

        <div>
          <label className="block text-xs font-semibold text-[#1B2A4A] mb-1.5">PayPal Link</label>
          <input
            type="url"
        ...
        <div>
          <label className="block text-xs font-semibold text-[#1B2A4A] mb-1.5">Cash App / Other Link</label>
          <input
            type="url"
        ...
        <div>
          <label className="block text-xs font-semibold text-[#1B2A4A] mb-1.5">Additional Give Text</label>
          <textarea
            rows={4}
