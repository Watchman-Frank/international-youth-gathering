...
export default function MorePage() {
  return (
    <div className="max-w-lg mx-auto px-4 sm:px-6 py-8 space-y-8 lg:hidden">
      <h1 className="text-2xl font-bold text-[#1B2A4A]" style={{ fontFamily: "var(--font-fraunces, Georgia, serif)" }}>
        More
      </h1>
            ...
            {items.map(({ href, label, icon: Icon, desc }, i) => (
              ...
              >
                <div className="w-10 h-10 rounded-xl bg-[#FAF8F3] flex items-center justify-center flex-shrink-0">
                  <Icon size={18} className="text-[#1B2A4A]" aria-hidden />
                </div>
                <div>
        ...
        <div className="bg-white rounded-2xl border border-slate-100 overflow-hidden">
          <a href="tel:+16074442359" className="flex items-center gap-4 p-4 hover:bg-slate-50">
            <div className="w-10 h-10 rounded-xl bg-[#FAF8F3] flex items-center justify-center">
              <Phone size={18} className="text-[#1B2A4A]" aria-hidden />
            </div>
            <div>
              <div className="font-semibold text-[#1B2A4A] text-sm">+1 607 444 2359</div>
          ...
          <a href="mailto:info@internationalyouthgathering.com" className="flex items-center gap-4 p-4 border-t border-slate-100 hover:bg-slate-50">
            <div className="w-10 h-10 rounded-xl bg-[#FAF8F3] flex items-center justify-center">
              <Mail size={18} className="text-[#1B2A4A]" aria-hidden />
            </div>
            <div>
              <div className="font-semibold text-[#1B2A4A] text-sm">info@internationalyouthgathering.com</div>
          ...
          <a href="https://facebook.com/international_youthgathering" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 border-t border-slate-100 hover:bg-slate-50">
            ...
            <div>
              <div className="font-semibold text-[#1B2A4A] text-sm">@international_youthgathering</div>
